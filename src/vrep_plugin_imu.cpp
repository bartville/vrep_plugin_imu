...
#include "../include/vrep_plugin_imu/vrep_plugin_imu.h"
...
VREP_DLLEXPORT unsigned char v_repStart(void* reservedPointer,int reservedInt)
{
	...
	simRegisterCustomLuaVariable("simros_strmcmd_get_imu_state",(boost::lexical_cast<std::string>(int(simros_strmcmd_get_imu_state))).c_str());
